        ...
        <div className="surface-card">
          <div className="flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
            ...
            <button
              ...
              className="w-full rounded-xl bg-blue-600 px-4 py-2 text-sm text-white sm:w-auto"
            >
              ...
              return (
                <div key={disease} className="rounded-3xl bg-white p-5 shadow-sm">
                  <div className="flex flex-col gap-2 sm:flex-row sm:items-start sm:justify-between">
                    ...
                    <span className={isAbnormal ? "text-rose-600" : "text-emerald-600"}>
                      {isAbnormal ? "Needs attention" : "Stable"}
                    </span>
                  </div>

                  <div className="chart-scroll mt-4">
                    <div className="h-52 min-w-[340px] sm:min-w-0">
              ...
              <div key={report._id} className="mt-4 rounded border p-3">
                <div className="flex flex-col gap-3 sm:flex-row sm:items-start sm:justify-between">
                  ...
                  <button
                    ...
                    className="w-full rounded-lg bg-slate-900 px-3 py-1.5 text-xs text-white sm:w-auto"
                  >
                    PDF
                  </button>
                </div>
